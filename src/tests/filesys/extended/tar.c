...
static bool
archive_file(char file_name[], size_t file_name_size, int archive_fd, bool *write_error)
{
...
static bool
archive_ordinary_file(const char *file_name, int file_fd, int archive_fd, bool *write_error)
{
...
static bool
archive_directory(char file_name[], size_t file_name_size, int file_fd, int archive_fd, bool *write_error)
{
    size_t dir_len;
    bool success = true;
...
static bool
write_header(const char *file_name, enum ustar_type type, int size, int archive_fd, bool *write_error)
{
