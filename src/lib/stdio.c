...
/* Performs an integer conversion, writing output to OUTPUT with
   ...
   are in C. */
static void
format_integer(uintmax_t value, bool is_signed, bool negative, const struct integer_base *b, const struct printf_conversion *c, void (*output)(char, void *), void *aux)
{
...
/* Formats the LENGTH characters starting at STRING according to
   ...
   auxiliary data AUX. */
static void
format_string(const char *string, int length, struct printf_conversion *c, void (*output)(char, void *), void *aux)
{
    int i;
